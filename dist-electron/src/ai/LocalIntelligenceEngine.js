...
exports.localIntelligenceEngine = exports.LocalIntelligenceEngine = void 0;
class LocalIntelligenceEngine {
     ...
     */
    decomposeObjective(objective, missionId) {
        ...
        const taskResearch = {
            ...
            description: 'Analyze state of the art patterns, modern component structures, bundle optimization techniques, and responsive layouts.',
            agentId: 'research',
            status: 'PENDING',
        ...
        const taskDesign = {
            ...
            description: 'Audit current visual presentation, define cohesive color palette, modern typography tokens, spacing system, and layout grid.',
            agentId: 'design',
            status: 'PENDING',
        ...
        const taskPerformanceAudit = {
            ...
            description: 'Perform static analysis on contrast ratios, semantic HTML landmarks, ARIA labels, and render cycle efficiency.',
            agentId: 'tester',
            status: 'PENDING',
        ...
        const taskImplementation = {
            ...
            description: 'Apply design system tokens, integrate research recommendations, write clean component code, and eliminate performance bottlenecks.',
            agentId: 'coder',
            status: 'PENDING',
        ...
        const taskFinalReview = {
            ...
            description: 'Verify modified components, check for syntax errors, validate responsive layouts, and issue final pass/fail certification.',
            agentId: 'tester',
            status: 'PENDING',
...
exports.LocalIntelligenceEngine = LocalIntelligenceEngine;
exports.localIntelligenceEngine = LocalIntelligenceEngine.getInstance();
