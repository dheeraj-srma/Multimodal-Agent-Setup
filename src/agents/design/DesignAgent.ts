...
import { AgentTask, DesignSpecification } from '../../types';
...
export class DesignAgent extends BaseAgent {
  ...
  protected async execute(task: AgentTask): Promise<DesignSpecification> {
    ...
    const spec = await localIntelligenceEngine.executeDesign(task.description);
